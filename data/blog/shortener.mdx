...
- Menggunakan [package ini](https://www.npmjs.com/package/netlify-shortener) atau ingin lebih powerfull maka bisa digabungkan dengan [zsh alias](https://zsh.sourceforge.io/Intro/intro_8.html).
...
<div style={{ paddingTop: '1rem' }}>
  <Image
    alt={`Deploy`}
    src={`/static/images/shortener/deploy.png`}
    width={1130}
    height={530}
  />
